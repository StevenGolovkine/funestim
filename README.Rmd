...
covariance of a functional dataset using an estimation of the regularity of the
curves. The curves can be irregularly sampled.
...
Please use [GitHub issues](https://github.com/StevenGolovkine/simulater/issues)
